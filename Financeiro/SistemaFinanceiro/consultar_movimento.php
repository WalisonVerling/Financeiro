...
if (isset($_POST['BtnGravar'])) {
    ...
    $movs = $objdao->FiltrarMovimento($tipo, $datainicial, $datafinal);
    ...
    $objdao = new MovimentoDAO();
    $retorno = $objdao->ExcluirMovimento($idMov, $idConta, $valor, $tipo);
}
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5>Consulte todas os seus movimentos em um determinado período. </h5>
                    </div>
                </div>
                <hr />
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="tipo">
                                ...
                                <option value="2" <?= $tipo == 2 ? 'selected' : '' ?>>Sáida</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="dataInicial" id="data_inicial" value="<?= isset($datainicial) ? $datainicial : '' ?>" id="" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Data Final</label>
                            <input type="date" class="form-control" name="dataFinal" id="data_final" value="<?= isset($datafinal) ? $datafinal : '' ?>" id="" />
                        </div>
                    </div>
                    <center>
                        <button class="btn btn-primary" name="BtnGravar" onclick="return ValidarConsultaPeriodo()">Pesquisar</button>
                    </center>
                </form>
                <hr>
                <?php if (isset($movs)) { ?>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <b>
                                                                                    <center>Deseja excluir o Movimento:</center>
                                                                                </b> <br>
